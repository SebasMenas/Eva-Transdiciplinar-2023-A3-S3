...
txt_1_label = ctk.CTkLabel(buttons_frame, width=5, height=10, text="Altura:",
                           font=ctk.CTkFont(size=12, weight="bold"))  # Crear texto dentro de buttons_frame
txt_1_label.grid(row=0, column=0, columnspan=2, pady=15,
                 sticky="sew")  # Posicionamiento del texto dentro de buttons_frame
...
b_1 = ctk.CTkSegmentedButton(buttons_frame, width=60, height=10, values=[" Km ", "  m  "],
                             command=altura)  # Segmented button, para 2 botones en 1
b_1.grid(row=1, column=1, padx=2, pady=8, sticky="nw")  # Posicion y config del segmented button
b_1.set("  m  ")

# Ocupan filas 3;4
txt_2_label = ctk.CTkLabel(buttons_frame, width=5, height=10, text="Velocidad inicial:",
...
# Ocupan filas 6;7
txt_3_label = ctk.CTkLabel(buttons_frame, width=5, height=10, text="Aceleración: ",
                           font=ctk.CTkFont(size=12, weight="bold"))
...
# Ocupan filas 9;10
txt_4_label = ctk.CTkLabel(buttons_frame, width=5, height=15, text="Algún otra función:",
                           font=ctk.CTkFont(size=12, weight="bold"))
